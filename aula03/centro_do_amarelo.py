...
print("https://github.com/Insper/robot21.1/raw/main/aula03/yellow.mp4")
...
while(True):
    ...
    mask_bgr = center_of_mass_region(mask, 20, 400, frame.shape[1] - 80, frame.shape[0]-100) # Lembrando que negativos contam a partir do fim`
